  ...
  <main>
    ...
    >
      <ul class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <li v-for="item in project.data" :key="item.link" class="border border-neutral-200 rounded-md hover:border-neutral-500 dark:border-neutral-700 dark:hover:border-neutral-500 duration-300">
          <NuxtLink
